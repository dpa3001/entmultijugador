...
public class FindDuplicates_Executor6 {
	...
	public void exec() {
		/*
		 * Si ejecutamos el código...se puede ver que las salidas se mezclan
		 * 
		 * Para ello debemos de SINCRONIZAR EL CÓDIGO NECESARIO (MIRAR ARRIBA)
		 */
...
//		new Thread(()->findDuplicates(new File("X:\\DirB"))).start();
	...
	public static void main(String[] args) {
		new FindDuplicates_Executor6().exec();
	}
}